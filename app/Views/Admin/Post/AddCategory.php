...
<div class="col-md-6">
    <form action="<?php echo BASE_URL?>PostController/insertCategory" method="POST">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <textarea id="editor" style="resize: none;" class="form-control" name="category_post_desc"></textarea>
        </div>
